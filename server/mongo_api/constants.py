...
DATABASE_CONNECTION_STRING = f"mongodb://{credentials.DATABASE_USERNAME}:{urllib.parse.quote(credentials.DATABASE_PASSWORD)}@localhost:27017/?authMechanism=DEFAULT"
